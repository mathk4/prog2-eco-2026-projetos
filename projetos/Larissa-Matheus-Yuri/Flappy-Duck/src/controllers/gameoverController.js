//verificar se a pontuação do jogador é maior que a pontuação feita no jogo atual, se não for maior mostrar na view a pontuação do jogador e a pontuação feita no jogo atual
